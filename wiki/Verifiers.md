...
No recompile, no Go. The bundled set already covers 65+ providers (GitHub, AWS, Stripe, Slack, OpenAI, Anthropic, and more) — read any of them under `verifiers/` for a working template.
